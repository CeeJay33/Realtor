...
<head>
  ...
  <section class="hero-section">
    ...
    <div class="hero-image">
      ...
      <img src="/images/—Pngtree—real estate agent transparent background_13621075.png" class="z-40" alt="Antique Vase">
      
    </div>
    <div class="hero-content">
      <h1 class="font-mono ">Find The Right Agent For Your Home </h1>
      <p class="">Discover properties that match your lifestyle and budget. From cozy apartments to luxury estates.</p>
      <div class="hero-buttons">
        <button class="shop-now">Contact Now</button>
        <button class="watch-video">
          <span class="play-icon">▶</span> Get Info
        </button>
      </div>
...
.hero-section {
  ...
  justify-content: center;
   background-image: linear-gradient(rgba(255, 255, 255, 0.743), rgba(255, 255, 255, 0.817)), url(/images/5001147_19742.jpg);
