    ...
    >
      ...
      >
        <div class="truck-card">
          ...
          >
            <img :src="`/images/${property.primary_photo.href}`" />
          ...
          >
            ...
            <div class="sponsored">
              Status • <span class="dealer-name">{{ property.status }}</span>
            </div>
            <ul class="truck-details">
              <li class="flex justify-center items-center gap-2">
                ...
                {{ property.description.beds }} Bedrooms
              </li>
              <li class="flex justify-center items-center gap-2">
                <div >
                  <svg
			...
			c11.087-3.882,21.808-8.819,31.991-14.795c6.444-3.782,12.629-7.962,18.543-12.483l28.236,73.93H434.319z"
                ...
                {{ property.description.baths }} Bathrooms
              </li>
              <li class="flex justify-center items-center gap-2">
                <div >
                  <svg
            ...
            <div class="pricing" >
              <div class="price">$ {{ formatNumber(property.list_price) }}</div>
            ...
            >
              <p>
                {{ property.location.neighborhoods[0].city }},
                {{ property.location.neighborhoods[0].state_code }}
              </p>
            </div>
            ...
            <div class="buttons flex justify-between">
              ...
              <div class="time__posted flex justify-center items-center gap-2">
                ...
                <div >
                  <p>{{ property.source.agents[0].agent_name }}</p>
                </div>
              </div>
 ...
 async mounted() {
  try {
    ...
    if (data && Array.isArray(data.results)) {
      this.propertiesData = data.results; 
    } else {
